          ...
          <Box>
            ...
            <Input>
              <InputField placeholder="https://..."
                value={imageUrl} onChangeText={setImageUrl} autoCapitalize="none" />
            </Input>

            <Text className="mt-2">Playlist ID</Text>
            <Input>
              <InputField placeholder="spotify:playlist:..." value={playlistId} onChangeText={setPlaylistId} autoCapitalize="none" />
            </Input>

            <Text className="mt-2">Beginning (ISO string)</Text>
            <Input>
              <InputField placeholder="2025-09-09T18:00:00Z" value={beginningAt} onChangeText={setBeginningAt} autoCapitalize="none" />
            </Input>

            <Text className="mt-2">Ending (ISO string)</Text>
            <Input>
              <InputField placeholder="2025-09-09T20:00:00Z" value={endingAt} onChangeText={setEndingAt} autoCapitalize="none" />
            </Input>
            ...
            <Input>
              <InputField placeholder="Venue name" value={venueName} onChangeText={setVenueName} />
            </Input>

            <Text className="mt-2">Complement</Text>
            <Input>
              <InputField placeholder="Suite, floor..." value={complement} onChangeText={setComplement} />
            </Input>

            <Text className="mt-2">Address</Text>
            <Input>
              <InputField placeholder="Street address" value={address} onChangeText={setAddress} />
            </Input>
