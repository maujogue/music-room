      ...
      <Drawer isOpen={showDrawer} onClose={handleClose}>
        ...
        <DrawerContent className="w-[270px] md:w-[300px]">
          <DrawerHeader>
            <HStack className="gap-3 items-center">
                <Image
                  ...
                  alt='Playlist image'
                />
              <Text size="4xl" className="font-semibold">{playlist?.name}</Text>
            </HStack>
          </DrawerHeader>
          ...
          <DrawerBody contentContainerClassName="gap-2">
            ...
            >
              <HStack className="gap-3 items-center">
                <Icon as={GlobeIcon} size="lg" className="text-typography-600" />
            ...
            <Pressable
              ...
              disabled
            >
              <Icon as={PaperclipIcon} size="lg" className="text-typography-600" />
            ...
            <Pressable
              ...
              disabled
            >
              <Icon as={SettingsIcon} size="lg" className="text-typography-600" />
