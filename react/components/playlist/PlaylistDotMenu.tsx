...
export default function Playlist3DotMenu({ callDelete }: Props) {
  ...
  return (
    ...
    >
      ...
      {/* MOCK MENU */}
      <MenuSeparator />
      <MenuItem key="share" disabled={true} textValue="Share" className='p-2 justify-between'>
        <HStack>
          <Icon as={GlobeIcon} size="sm" className="mr-2 color-secondary-700" />
          <MenuItemLabel size="sm" className="color-secondary-700">Share</MenuItemLabel>
        </HStack>
      ...
      <MenuItem key="pin" disabled={true} textValue="Pin">
        <Icon as={PaperclipIcon} size="sm" className="mr-2 color-secondary-700" />
        <MenuItemLabel size="sm" className="color-secondary-700">Pin</MenuItemLabel>
      </MenuItem>
      <MenuItem key="settings" disabled={true} textValue="Settings">
        <Icon as={SettingsIcon} size="sm" className="mr-2 color-secondary-700" />
        <MenuItemLabel size="sm" className="color-secondary-700">Settings</MenuItemLabel>
      </MenuItem>
    </Menu>
  )
}
