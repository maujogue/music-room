...
export default function PlaylistHeader({ playlist, onRefresh }: Props) {
    ...
    return (
        ...
        <Card>
            ...
            <AlertDialog isOpen={showCollaboratorAlert} onClose={handleCancelCollaboratorDowngrade}>
                <AlertDialogBackdrop />
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogCloseButton onPress={handleCancelCollaboratorDowngrade} />
                    </AlertDialogHeader>
                    <AlertDialogBody className="mt-3 mb-4">
                        <Text size="sm">
                            You are currently a collaborator on this playlist. If you unlike it, you will lose your collaborator privileges and become a regular member. Are you sure you want to continue?
                        </Text>
                    </AlertDialogBody>
