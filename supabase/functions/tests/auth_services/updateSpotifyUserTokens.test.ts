...
describe("updateSpotifyUserTokens", () => {
    ...
    let updateSpotifyUserTokens: (user_id: string, spotify_token_data: any) => Promise<void>;
    let dateNowStub: any;
    ...
    beforeEach(() => {
        ...
        updateSpotifyUserTokens = async (user_id: string, spotify_token_data: any): Promise<void> => {
    ...
    it("should handle special characters in tokens", async () => {
        ...
        const params = supabaseMock.getCapturedUpsertParams();
        assertExists(params);
        assertEquals(params.spotify_access_token, "token-with-special_chars.123-ABC");
        assertEquals(params.spotify_refresh_token, "refresh_token.with-dots_and-dashes");
    });
