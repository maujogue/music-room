  ...
  for (const key of Object.keys(body as object)) {
    ...
    switch (key) {
      ...
      case 'email':
        ...
        break;
      case 'avatar_url':
        if (value === null || typeof value === 'string') profilePayload.avatar_url = value;
        else errors.push('avatar_url must be a string or null');
        break;
      case 'bio':
        if (value === null || typeof value === 'string') profilePayload.bio = value;
      ...
      case 'privacy_setting':
        ...
        else errors.push('privacy_setting must be public, friends ou private');
        break;
    }
  }
